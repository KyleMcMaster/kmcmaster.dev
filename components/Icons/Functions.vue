  ...
  <svg class="NuxtLogo" xmlns="http://www.w3.org/2000/svg" width="180" height="180" viewBox="0 0 18 18">
    <defs>
      <linearGradient id="b403aca7-f387-4434-96b4-ae157edc835f" x1="-175.993" y1="-343.723" x2="-175.993" y2="-359.232" gradientTransform="translate(212.573 370.548) scale(1.156 1.029)" gradientUnits="userSpaceOnUse">
        ...
        <stop offset="0.284" stop-color="#35495e"/>
        <stop offset="0.547" stop-color="#35495e"/>
        <stop offset="0.8" stop-color="#35495e"/>
    ...
    <g>
      <path d="M14.53,7.475h.833a.533.533,0,0,1,.533.533v6.148a.267.267,0,0,1-.267.267H14.8a.267.267,0,0,1-.267-.267V7.475a0,0,0,0,1,0,0Z" transform="translate(12.223 -7.555) rotate(45.081)" fill="#35495e"/>
